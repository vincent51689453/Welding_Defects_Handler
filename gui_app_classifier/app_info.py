...
#--------------------------------------------------------------------
common_console_length = 60

#Console_left (incomplete penetration)
...
text_ai_box_w_l = common_console_length
text_ai_box_h_l = 1
text_ai_box_x_l = 130
text_ai_box_y_l = 10

#Console_middle (incomplete fusion)
...
text_ai_box_w_m = common_console_length
text_ai_box_h_m = 1
text_ai_box_x_m = 130
text_ai_box_y_m = 45

#Console_right (porosity)
...
text_ai_box_w_r = common_console_length
text_ai_box_h_r = 1
text_ai_box_x_r = 130
text_ai_box_y_r = 80
#Console_extra (underfill)
app_ai_console_x_fontstyle = "DejaVu Serif"
app_ai_console_x_fontsize = 12
app_ai_console_x_background = 'black'
app_ai_console_x_foreground = 'white'
text_ai_box_w_x = common_console_length
text_ai_box_h_x = 1
text_ai_box_x_x = 130
text_ai_box_y_x = 115
